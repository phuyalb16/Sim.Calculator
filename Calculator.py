...
master = Tk()
display = Entry(master, width=14, justify ="right", bd=0, bg='white') #display box in the calculator

master.title("Sim.Calc")           #gives calculator the name
...
# equate function adds, substracts, multiplies, divides
    def equate(self):
...
display.place(x=0, y=2)  #places at the x y z
